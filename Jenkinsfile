...
import java.io.File
def scriptApproval = org.jenkinsci.plugins.scriptsecurity.scripts.ScriptApproval.get().approveSignature("staticMethod java.lang.System setProperty java.lang.String java.lang.String")
scriptApproval.save()
